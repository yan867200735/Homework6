...
var Astar = (function () {
    function Astar(BM, Pl) {
        this.StartN = new node();
        this.EndN = new node();
        this.nowN = new node();
        this.IsOk = false;
        this.EndNcanW = false;
    ...
    p.jisuan = function (tx, ty) {
        ...
        do {
            ...
            if (this.nowN.fn.x == this.StartN.x && this.nowN.fn.y == this.StartN.y) {
                break;
            }
